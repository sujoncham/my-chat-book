        ...
        <div className='bg-white border-2 px-2 py-3 my-5 rounded-lg'>
            <div className='flex justify-start gap-2'>
                ...
                <div className='border-2 rounded-lg relative'>
                    <img className='w-36 h-[100%] rounded-lg' src="/images/3.jpg" alt="" />
                    <img className='w-14 h-14 rounded-full absolute top-2 left-2 z-2 border-4 border-purple-500' src="/images/5.jpg" alt="" />
